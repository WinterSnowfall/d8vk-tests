...
class RGBTriangle {
    ...
    public:
        ...
        RGBTriangle(HWND hWnd) : m_hWnd(hWnd) {
            ...
            Direct3DCreate9Ex = (decltype(Direct3DCreate9Ex))GetProcAddress(hm, "Direct3DCreate9Ex");
        ...
        void testBeginSceneReset() {
            ...
            if (SUCCEEDED(m_device->BeginScene())) {
                ...
                if (FAILED(status)) {
                    ...
                    // Reset() will NOT have cleared the state in D3D9Ex
                    if (FAILED(m_device->BeginScene()) && SUCCEEDED(m_device->EndScene())) {
                        m_passedTests++;
        ...
        void testDepthStencilFormats() {
            ...
            std::map<D3DFORMAT, char const*> dsFormats = { {D3DFMT_D16_LOCKABLE, "D3DFMT_D16_LOCKABLE"},
                                                           ...
                                                           // The following two formats are D3D9Ex specific
...
int main(int, char**) {
    WNDCLASSEX wc = {sizeof(WNDCLASSEX), CS_CLASSDC, WindowProc, 0L, 0L,
                     ...
                     "D3D9Ex_Triangle", NULL};
    RegisterClassEx(&wc);

    HWND hWnd = CreateWindow("D3D9Ex_Triangle", "D3D9Ex Triangle - Blisto Ultra Modern Testing Edition",
